...
public interface EnemyChoiceStrategyFactory {
     ...
     * @param maxDistanceAllowed the maximum allowed distance from the defense to be an eligible target.
     * All enemies receive the base damage of the tower
     */
    EnemyChoiceStrategy closestTargets(int maxTargets, int maxDistanceAllowed);
     ...
     * @param maxDistanceAllowed the max distance allowed from the defense to be eligible as a first target.
     */
    EnemyChoiceStrategy closestTargetWithAreaDamage(int damageRange, int maxDistanceAllowed);
}
